...
import "./Navbar.css";
import OL from "../../assets/OL-logo1.png";
  ...
  return (
    <header className="navbar-header">
      <div className="item-width">
        <div>
          <img id="ol-logo" src={OL} alt="OL-logo" />
        </div>
        <nav ref={navRef}>
          <a onClick={(e) => scrollToSection("home", e)} href="#">
            Home
          </a>
          <a onClick={(e) => scrollToSection("about", e)} href="#">
            About
          </a>
          <a onClick={(e) => scrollToSection("projects", e)} href="#">
            Projects
          </a>
          <a onClick={(e) => scrollToSection("contact", e)} href="#">
            Contact
          </a>
